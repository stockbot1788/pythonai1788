...
x_drop4 = Dropout(0.5, name='input_drop')(ls11)
...
x_drop = Dropout(0.5, name='input_drop')(ls21)
...
x_drop2 = Dropout(0.5, name='input_drop')(output21)
...
x_drop3 = Dropout(0.5, name='input_drop')(output)
